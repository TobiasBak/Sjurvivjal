...
4. Build Project (Modify Paths): ``"C:\Program Files\Epic Games\UE_5.6\Engine\Build\BatchFiles\Build.bat" SjurvivjalEditor Win64 Development "c:\apps\Sjurvivjal\Sjurvivjal.uproject"``
